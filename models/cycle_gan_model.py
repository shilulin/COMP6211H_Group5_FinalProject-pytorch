...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'idt_A', 'D_B', 'G_B', 'idt_B']  #'cycle_A','cycle_B', 
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        if self.isTrain:
            self.visual_names  = ['real_A', 'fake_B','real_B', 'fake_A'] # 'rec_A'
        else:
    ...
    def backward_G(self):
        ...
        # combined loss and calculate gradients   self.loss_cycle_A + self.loss_cycle_B +
